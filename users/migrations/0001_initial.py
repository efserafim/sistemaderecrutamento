    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='Último ano')),
                ('email', models.EmailField(blank=True, max_length=254, verbose_name='email')),
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into this admin site.', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date joined')),
                ('role', models.CharField(choices=[('CANDIDATE', 'Candidato'), ('RECRUITER', 'Recrutador'), ('ADMIN', 'Administrador')], default='CANDIDATE', help_text='Determines the user type and permissions', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('resume', models.TextField(blank=True, help_text='Candidate resume text', null=True)),
                ('skills', models.TextField(blank=True, help_text='Candidate skills (comma separated)', null=True)),
                ('experience', models.IntegerField(default=0, help_text='Years of experience')),
                ('education', models.TextField(blank=True, help_text='Education history', null=True)),
